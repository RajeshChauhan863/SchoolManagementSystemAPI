...
namespace BAL
{
    public class FeeService : IfeeService
    {
        ...
        {
            return _unitOfWork.FeeRepository.GetById(id);
        }
        ...
        public void AddFee(Fee inventory)
        {
            _unitOfWork.FeeRepository.Add(inventory);
            _unitOfWork.SaveChanges();
        }

        public void UpdateFee(Fee inventory)
        {
            _unitOfWork.FeeRepository.Update(inventory);
            _unitOfWork.SaveChanges();
        }

        public void DeleteFee(int id)
        {
            _unitOfWork.FeeRepository.Delete(id);
            _unitOfWork.SaveChanges();
        }

        public IEnumerable<Fee> GetAllFees()
        {
            return _unitOfWork.FeeRepository.GetAll();
        }
